...
/* harmony import */ var _bank_bank_list_component__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(/*! ./bank/bank-list.component */ "./src/app/bank/bank-list.component.ts");
/* harmony import */ var _compensation_compensation_component__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(/*! ./compensation/compensation.component */ "./src/app/compensation/compensation.component.ts");
/* harmony import */ var _compensation_compensationlist_component__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__(/*! ./compensation/compensationlist.component */ "./src/app/compensation/compensationlist.component.ts");
...
var routes = [
    ...
    { path: 'banklist',
        component: _bank_bank_list_component__WEBPACK_IMPORTED_MODULE_35__["BankListComponent"]
    },
    { path: 'compensation',
        component: _compensation_compensation_component__WEBPACK_IMPORTED_MODULE_36__["CompensationComponent"]
    },
    { path: 'compensationlist',
        component: _compensation_compensationlist_component__WEBPACK_IMPORTED_MODULE_37__["CompensationlistComponent"]
    },
...
/* harmony import */ var _bank_bank_list_component__WEBPACK_IMPORTED_MODULE_47__ = __webpack_require__(/*! ./bank/bank-list.component */ "./src/app/bank/bank-list.component.ts");
/* harmony import */ var _compensation_compensation_component__WEBPACK_IMPORTED_MODULE_48__ = __webpack_require__(/*! ./compensation/compensation.component */ "./src/app/compensation/compensation.component.ts");
/* harmony import */ var _compensation_compensationlist_component__WEBPACK_IMPORTED_MODULE_49__ = __webpack_require__(/*! ./compensation/compensationlist.component */ "./src/app/compensation/compensationlist.component.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            declarations: [
                ...
                _bank_bank_list_component__WEBPACK_IMPORTED_MODULE_47__["BankListComponent"],
                _compensation_compensation_component__WEBPACK_IMPORTED_MODULE_48__["CompensationComponent"],
                _compensation_compensationlist_component__WEBPACK_IMPORTED_MODULE_49__["CompensationlistComponent"],
            ],
            imports: [
...
/***/ "./src/app/bank/bank-list.component.css":
/*!**********************************************!*\
  !*** ./src/app/bank/bank-list.component.css ***!
  \**********************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2JhbmsvYmFuay1saXN0LmNvbXBvbmVudC5jc3MifQ== */"

/***/ }),

/***/ "./src/app/bank/bank-list.component.html":
/*!***********************************************!*\
  !*** ./src/app/bank/bank-list.component.html ***!
  \***********************************************/
/*! no static exports found */
...
var BankListComponent = /** @class */ (function (_super) {
    ...
    BankListComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            template: __webpack_require__(/*! ./bank-list.component.html */ "./src/app/bank/bank-list.component.html"),
            styles: [__webpack_require__(/*! ./bank-list.component.css */ "./src/app/bank/bank-list.component.css")]
        }),
...
module.exports = "<app-navbar></app-navbar>\n<style>\n  .grad{\n background-image: linear-gradient(to bottom right, rgb(32, 168, 168), rgb(219, 231, 237));\n background-repeat: no repeat;\n background-size: 100%;\n padding-bottom: 25px\n ;\n }\n</style>\n<div class=\"row \" style=\"padding-top: 3%; padding-bottom:15%;\nbackground: url(assets/files/wall.jpg) no-repeat center center;\nbackground-attachment: fixed;\nbackground-size: cover;width:auto;\n  height: auto;\">\n\n  <div class=\"col-sm-4\"></div>\n  <div class=\"col-sm-4\">\n    <div class=\"card\">\n      <div class=\"card-body shadow-lg grad\">\n        <form>\n          <h2 *ngIf=\"!form.data.id>0\" class=\"text-primary font-weight-bold\" style=\"text-align: center;\">{{'Add Account' | translate }}</h2>\n          <h2 *ngIf=\"form.data.id>0\" class=\"text-primary font-weight-bold\" style=\"text-align: center;\">{{'Update Account' | translate }}</h2>\n\n          <div *ngIf=\"form.error && form.message != null\" class=\"alert alert-danger alert-dismissible\">\n            <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>\n            {{form.message}}\n          </div>\n          <div *ngIf=\"!form.error && form.message != null\" class=\"alert alert-success alert-dismissible\">\n            <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>\n            {{form.message}}\n          </div>\n\n          <div style=\"padding-top:3%\">\n            <span class=\"pt-2\"><b>{{'Name' | translate }}</b>\n              <span class=\"required-field\"></span></span>\n            <div class=\"col-sm-12\">\n              <div class=\"input-group\">\n                <div class=\"input-group-prepend\">\n                  <div class=\"input-group-text\"><i class=\"fa fa-file grey-text\"></i> </div>\n                </div>\n                <input type=\"text\" name=\"name\" [(ngModel)]=\"form.data.name\" class=\"form-control\"\n                  placeholder=\"{{'Enter Your Name' | translate }}\">\n              </div>\n            </div><span class=\"alertRedColor\"> {{form.inputerror.name}} </span>\n          </div>\n\n          <div style=\"padding-top:3%\">\n            <span class=\"pt-2\"><b>{{'Account Number' | translate }}</b>\n              <span class=\"required-field\"></span></span>\n            <div class=\"col-sm-12\">\n              <div class=\"input-group\">\n                <div class=\"input-group-prepend\">\n                  <div class=\"input-group-text\"><i class=\"fa fa-file grey-text\"></i> </div>\n                </div>\n                <input type=\"text\" name=\"accountNumber\" [(ngModel)]=\"form.data.accountNumber\" class=\"form-control\"\n                  placeholder=\"{{'Enter Accout Number' | translate }}\">\n              </div>\n            </div><span class=\"alertRedColor\"> {{form.inputerror.accountNumber}} </span>\n          </div>\n\n\n          <div style=\"padding-top:3%\">\n            <span class=\"pt-2\"><b>{{'Pending Loan' | translate }}</b>\n              <span class=\"required-field\"></span></span>\n            <div class=\"col-sm-12\">\n              <div class=\"input-group\" >\n                <div class=\"input-group-prepend\">\n                  <div class=\"input-group-text\"><i class=\"fa fa-clock-o grey-text\"></i> </div>\n                </div>\n            \n                <select class=\"form-control\" name=\"pendingLoan\"\n                  [(ngModel)]=\"form.data.pendingLoan\" style=\"cursor: pointer;\">\n                  <option [ngValue]=\"\" value=\"undefined\">{{'Please select' | translate }}</option>\n                  <option>Due</option>\n                  <option>Clear</option>\n                 \n\n                </select>\n              </div>\n              <span class=\"alertRedColor\"> {{form.inputerror.pendingLoan}} </span>\n            </div>\n          </div>\n\n          \n\n          <div>\n            <span class=\"pt-2\"><b>{{'Balance' | translate }}</b>\n              <span class=\"required-field\"></span></span>\n            <div class=\"col-sm-12\">\n              <div class=\"input-group\">\n                <div class=\"input-group-prepend\">\n                  <div class=\"input-group-text\"><i class=\"fa fa-bars grey-text\"></i> </div>\n                </div>\n                <input type=\"text\" name=\"balance\" [(ngModel)]=\"form.data.balance\" class=\"form-control\"\n                placeholder=\"{{'Enter Balance' | translate }}\">\n              </div>\n            </div><span class=\"alertRedColor\"> {{form.inputerror.balance}} </span>\n          </div>\n\n\n          <div class=\"row pt-3 pl-3 pb-3\">\n            <div class=\"pt-2\">\n              <button *ngIf=\"!form.data.id>0\" (click)=\"submit()\" class=\"btn btn-success mr-2\">\n                {{'Save' | translate }}</button>\n            </div>\n            <div class=\"pt-2\">\n              <button *ngIf=\"form.data.id>0\" (click)=\"submit()\" class=\"btn btn-success mr-2\">\n                {{'Update' | translate }}</button>\n            </div>\n            <div class=\"pl-3 pt-2\">\n              <button (click)=\"forward('/banklist')\" type=\"button\" class=\"btn btn-warning mr-1\">{{'List\n                ' | translate }}              </button>\n            </div>\n          </div>\n        </form>\n      </div>\n    </div>\n  </div>\n</div>\n<app-footer></app-footer>"
...
var BankComponent = /** @class */ (function (_super) {
    ...
    BankComponent.prototype.validate = function () {
...
/***/ "./src/app/compensation/compensation.component.css":
/*!*********************************************************!*\
  !*** ./src/app/compensation/compensation.component.css ***!
  \*********************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2NvbXBlbnNhdGlvbi9jb21wZW5zYXRpb24uY29tcG9uZW50LmNzcyJ9 */"

/***/ }),

/***/ "./src/app/compensation/compensation.component.html":
/*!**********************************************************!*\
  !*** ./src/app/compensation/compensation.component.html ***!
  \**********************************************************/
/*! no static exports found */
...
/***/ "./src/app/compensation/compensation.component.ts":
/*!********************************************************!*\
  !*** ./src/app/compensation/compensation.component.ts ***!
  \********************************************************/
...
var CompensationComponent = /** @class */ (function () {
    function CompensationComponent() {
    }
    CompensationComponent.prototype.ngOnInit = function () {
    };
    CompensationComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-compensation',
            template: __webpack_require__(/*! ./compensation.component.html */ "./src/app/compensation/compensation.component.html"),
            styles: [__webpack_require__(/*! ./compensation.component.css */ "./src/app/compensation/compensation.component.css")]
        }),
...
/***/ "./src/app/compensation/compensationlist.component.css":
/*!*************************************************************!*\
  !*** ./src/app/compensation/compensationlist.component.css ***!
  \*************************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2NvbXBlbnNhdGlvbi9jb21wZW5zYXRpb25saXN0LmNvbXBvbmVudC5jc3MifQ== */"

/***/ }),

/***/ "./src/app/compensation/compensationlist.component.html":
/*!**************************************************************!*\
  !*** ./src/app/compensation/compensationlist.component.html ***!
  \**************************************************************/
/*! no static exports found */
...
module.exports = "<p>\n  compensationlist works!\n</p>\n"

/***/ }),

/***/ "./src/app/compensation/compensationlist.component.ts":
/*!************************************************************!*\
  !*** ./src/app/compensation/compensationlist.component.ts ***!
  \************************************************************/
/*! exports provided: CompensationlistComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CompensationlistComponent", function() { return CompensationlistComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");


var CompensationlistComponent = /** @class */ (function () {
    function CompensationlistComponent() {
    }
    CompensationlistComponent.prototype.ngOnInit = function () {
    };
    CompensationlistComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-compensationlist',
            template: __webpack_require__(/*! ./compensationlist.component.html */ "./src/app/compensation/compensationlist.component.html"),
            styles: [__webpack_require__(/*! ./compensationlist.component.css */ "./src/app/compensation/compensationlist.component.css")]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [])
    ], CompensationlistComponent);
    return CompensationlistComponent;
}());
...
var EndpointServiceService = /** @class */ (function () {
    function EndpointServiceService() {
        ...
        this.COMPENSATION = this.SERVER_URL + "/Compensation";
    }
...
module.exports = __webpack_require__(/*! C:\Rays Software\Workspace\p10\proect10_FrontCtl-main\ORSProject10-UI Fctl\src\main.ts */"./src/main.ts");
